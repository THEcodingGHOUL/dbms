...
<a href="<c:url value="/admin/subjectsinfo" />">See Subjects</a>
       ...
       <form:form method="post"  action="/springproject/admin/examsinfo/addexam"	modelAttribute="sr">    
        <table >       
         <tr>
         <td>Subject</td>
         ...
         <tr>    
          <td>exam Date</td>  
          <td><form:input path="examDate" required="required"/></td>  
         </tr> 
         ...
         <tr>    
          <td>Venue</td>    
          <td><form:input path="venue" required="required"/></td>  
         </tr> 
